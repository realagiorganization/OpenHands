#!/usr/bin/env python3
"""
Script to build a runtime image using PyInstaller.
"""
...
def build_runtime_image(base_image: str, no_cache: bool = False) -> str:
    ...
    """
    logger.info(f"Building runtime image with PyInstaller method...")
...
def main():
    ...
    runtime_image = build_runtime_image(args.base_image, args.no_cache)
